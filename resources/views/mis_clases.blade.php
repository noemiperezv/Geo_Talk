                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="card class-card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-3">
                                                    <h6 class="card-title"><i class="fa-solid fa-pen"></i></h6>
                                                </div>
                                                <div class="col-3">
                                                    <h6 class="card-title"><i class="fa-solid fa-trash-can"></i></h6>
                                                </div>
                                                <div class="col-6">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="card class-card" style="width: 18rem;">
                                        <div class="imagen-port">
                                            <img class="card-img-top" src="{{URL::asset('../../img/Español.jpg')}}" width="400" alt="Card image cap">
                                            <div class="hover-galeria">
                                                <a href="{{ route('mis_clases') }}" target="_blank">
                                                <img class="card-img-top" src="{{URL::asset('../../img/flech.png')}}" alt="Imagen no disponible">
                                                </a>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="card class-card" style="width: 18rem;">
                                        <div class="imagen-port">
                                            <img class="card-img-top" src="{{URL::asset('../../img/Alemán.jpg')}}" width="400" alt="Card image cap">
                                            <div class="hover-galeria">
                                                <a href="{{ route('mis_clases') }}" target="_blank">
                                                <img class="card-img-top" src="{{URL::asset('../../img/flech.png')}}" alt="Imagen no disponible">
                                                </a>
